...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            EVNDayPriceSensor(coordinator),
            EVNDayPriceVatSensor(coordinator),
            EVNNightPriceSensor(coordinator),
            EVNNightPriceVatSensor(coordinator),
            EVNCurrentPriceSensor(coordinator),
            EVNCurrentPriceVatSensor(coordinator),
            EVNCurrentTariffSensor(coordinator),
        ]
    )
